...
def create_one2one_gene_sets():
    ...
    with open(
      "/data/rbg/users/wmccrthy/chemistry/Everything/ +
      "EDA/regulatory_one2one_sets_metadata.csv", 
      "w") as write_to:
        writer = csv.writer(write_to)
